...
public class GreenDaoHelper extends Application {
    ...
    private static class MySQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            MigrationHelper.migrate(db,AreaDao.class, PeopleDao.class, ProductDao.class, CountryDao.class);
    ...
    private static class MyEncryptedSQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        private static final String UPGRADE="tchl upgrade";

        @Override
        public void onUpgrade(Database db, int oldVersion, int newVersion) {

            EncryptedMigrationHelper.migrate((EncryptedDatabase) db,AreaDao.class, PeopleDao.class, ProductDao.class, CountryDao.class);
            Log.e(UPGRADE,"upgrade run success");
        }
