...
public final class MigrationHelper {
    ...
    private static String TAG = "tchl MigrationHelper";
        ...
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            try {
                ...
                if(tableName.equals("AREA")){
                    Log.d(TAG,"area new insert:");
                    insertTableStringBuilder.append("INSERT INTO ").append(tableName).append(" (AREA_CODE,AREA_NAME) ").append(" SELECT * FROM ").append(tempTableName).append(";");
                }else{
                ...
                Log.d(TAG,"restore data sql:"+insertTableStringBuilder.toString());
                db.execSQL(insertTableStringBuilder.toString());
                if (DEBUG) {
